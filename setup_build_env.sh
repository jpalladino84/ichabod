...
if cat /etc/issue | grep "Amazon Linux AMI" > /dev/null; then
    ...
    yum install flex bison gperf libicu-devel libxslt-devel ruby Xvfb
    yum install giflib giflib-devel giflib-utils libjpeg-turbo libjpeg-turbo-devel libpng libpng-devel
